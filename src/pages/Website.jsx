...
import { Plane, Menu, X, LogIn, ArrowRight, FileCheck2, ShieldCheck, MessageCircle, FileStack, Facebook, Instagram, Linkedin, Send, CircleCheck as CheckCircle2 } from "lucide-react";
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        // Supabase not reachable yet — keep the fallback catalog.
      } finally {
        setLoading(false);
      }
    })();
            ...
            <div key={it.id} className="rounded-2xl overflow-hidden transition-transform hover:-translate-y-1" style={{ backgroundColor: "#fff", border: `1px solid ${T.border}` }}>
              ...
              <div className="p-6">
                <div
                  ...
                  style={{ backgroundColor: it.type === "product" ? "rgba(29,138,138,0.12)" : "rgba(110,190,61,0.12)", color: it.type === "product" ? "#1D8A8A" : T.greenDeep }}
                >
