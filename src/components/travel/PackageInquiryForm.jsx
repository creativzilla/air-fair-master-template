...
// Single reusable inquiry form for every travel package detail page — driven
// entirely by pkg.inquiryForm.fields. Add or change fields per package in
// lib/travelDestinations.js; this component never needs to change.
  ...
  const handleSubmit = async event => {
    ...
    try {
      ...
      const { error } = await supabase.from("form_submissions").insert({
        form_type: `travel_package_${pkg.slug}`,
    ...
    <div className="svc-form-card">
      {submitted ? (
        <div className="svc-success">
          ...
          <p>Thank you for your interest in {pkg.title}. Our travel specialists will review your inquiry and reach out with the next steps.</p>
          <div className="svc-success-actions">
            <a className="green-button" href="/travel-tours">
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="svc-form-head">
            ...
            <p>Fill out the form below and our travel specialists will get in touch with you shortly.</p>
          </div>
